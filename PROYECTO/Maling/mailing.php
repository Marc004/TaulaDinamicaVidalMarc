...
function CorreoVerificación($email, $user) {
    ...
    <div style='font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #e2e2e2; border-radius: 10px;'>
        ...
        <div style='text-align: center; margin: 20px 0;'>
            <a href='http://localhost:3000/PROYECTO/mailCheckAccount.php?NumeroVerif=$NumeroVerif&email=$email' 
        ...
        <p style='word-break: break-all;'>http://localhost:3000/PROYECTO/mailCheckAccount.php?NumeroVerif=$NumeroVerif&email=$email</p>
